  ...
  $.fn.extend({
    auto_kana_input: function(options) {
      ...
      is_special_key = function(keycode) {
        var special_keys;
        special_keys = [8, 13, 32, 37, 38, 39, 40, 229];
        return $.inArray(keycode, special_keys) !== -1;
      };
      is_rome_key = function(keycode) {
      ...
      append_character_to_kana_field = function(character) {
        ...
        return kana_field.val(value);
      };
      clear_kana_field = function() {
        return kana_field.val('');
      };
      ...
      append_rome_buffer = function(rome) {
        return rome_buffer += rome;
      };
      clear_rome_buffer = function() {
        return rome_buffer = '';
      };
      pop_rome_buffer = function() {
        var kana;
